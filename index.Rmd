...
diversity? In the community level of biological organization, which dimension of diversity best describe what we call biodiversity?
So, after four years I developed some numerical tools to quantify dimensionality of diversity, extending
the concept that was used and also developed new metrics to quantify beta diversity to consider different
components of diversity in a single numerical framework.
...
After that I stayed in Federal University of Rio Grande do Sul for a postdoc with professor Leandro Duarte
